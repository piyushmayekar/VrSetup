...
public class GasWeldingSetUP : MonoBehaviour
{
    public static GasWeldingSetUP instance;
    ...
    public void OnConnecteblackPipe()
    {
        ...
        bluePipEndPoint.transform.GetChild(0).transform.localPosition = new Vector3(0f, -219f, 136f);
        bluePipEndPoint.transform.GetChild(0).transform.localEulerAngles= new Vector3(-3.953f, 0f, 0f);
    ...
    public void OnConnecteRedPipe()
    {
        ...
        RedPipeEndPoint.transform.GetChild(0).transform.localPosition = new Vector3(-0.18f, 0.56f, 2.34f);
