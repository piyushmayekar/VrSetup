...
public class Experiment14FlowManager : MonoBehaviour
{
    public static Experiment14FlowManager instance;
    ...
    public GameObject flatFile;
    public GameObject flatFileImpression1, flatFileImpression2, sheet1, sheet2, finalSheet1, finalSheet2;
    ...
    #region Step 2: Remove burrs on both job sheets by Filing.
    ...
    public void Step2_EnableHighlighting(int num)
    {
        switch (num)
        {
            case 1:
                innerStep = 1;
                flatFile.GetComponent<Outline>().enabled = true;
                flatFileImpression1.SetActive(true);
                sheet1.SetActive(true);
                break;
            case 2:
                flatFile.GetComponent<Outline>().enabled = true;
                flatFileImpression2.SetActive(true);
                sheet2.SetActive(true);
                break;
            case 3:
                flatFile.GetComponent<Outline>().enabled = false;
                SetTextOnCanvas();
                break;
            default:
                break;
    ...
    #region Step 3: Clean both jobs by Wire brush.
    ...
    #region Step 4: Keep both jobs on Welding table for further steps.
    ...
    #region Step 13: Do tack welding on both ends and centre of the job.
    ...
    #region Step 14: Start Welding by Leftward Technique.
    ...
    #region Step 16: Check the defects on Joints with the help of Chipping Hammer.
    ...
    #region Step 17: Clean the job surface with wire brush and remove distortion.
